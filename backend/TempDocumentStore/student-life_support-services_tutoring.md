# Tutoring | Graceland University

Source URL: https://www.graceland.edu/student-life/support-services/tutoring/#top
...
Group tutoring locations and times vary depending on the course, so please check our schedule on Microsoft Bookings to find a session for the class you are looking for:Group Tutoring Times. After selecting “Group Tutoring,” use the “select staff” option featured above the calendar to locate the subject you’re interested in and click on the available time slot.

If there is not a group tutoring session or feasible time for the course of your choice, then please contact Dr. Jim Redmond atredmond1@graceland.edu. If a tutor is available, then a session will be set up. We are always looking for ways to improve our services, so if a tutor is not available or you feel something else should be offered through our tutoring services, we will do our best to work with you to rectify the situation. We look forward to being a part of your academic success here at Graceland!

For all classes and group tutoring times, please click on the following link:Group Tutoring Times.

Jim Redmond, PhD, DirectorFMS Library, Main Level, Room 119614.784.5206redmond1@graceland.edu
